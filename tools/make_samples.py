...
for line in [
    "ข้อมูลซ้ำ = งวด STM, เดือน, ปีงบประมาณ, ประเภทบริการ, ครั้ง(บริการ), Adj.RW ที่ชดเชย, ชดเชยก่อนหักเงินเดือน ตรงกันทั้ง 7 ฟิลด์ (ไม่เทียบค่า BR)",
...
with open(OUT / "test_invalid_rows.csv", "w", newline="", encoding="utf-8-sig") as f:
    ...
    w.writerow(["6901_IP_01", "6901", "2569", "IP ในเขต", "3,450,000.00", "3,346,000.00", "412", "455.1234", "3,380,083.06"])  # ซ้ำในไฟล์ (7 ฟิลด์ตรงกัน ต่างเฉพาะ BR)
